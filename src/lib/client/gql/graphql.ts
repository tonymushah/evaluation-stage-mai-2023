...
export type ClientNewTypeChantierQuery = { __typename?: 'FrontOfficeQuery', typeChantier: { __typename?: 'ClientTypeChantierQueries', list: { __typename?: 'TypeChantierResults', total: number, offset: number, limit: number, data: Array<{ __typename?: 'TypeChantier', duree: any, description: string, idTypeChantier: any, nom: string, prixTotal: any }> } } };
